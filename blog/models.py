...
class Personal(models.Model):
    ...
    image = models.ImageField(blank=True, null=True, verbose_name=f'image1', )
    image1 = models.ImageField(blank=True, null=True, verbose_name=f'image1', )
    image2 = models.ImageField(blank=True, null=True, verbose_name=f'image2', )
    image3 = models.ImageField(blank=True, null=True, verbose_name=f'image3', )
    image4 = models.ImageField(blank=True, null=True, verbose_name=f'image4', )
    image5 = models.ImageField(blank=True, null=True, verbose_name=f'image5', )
    image6 = models.ImageField(blank=True, null=True, verbose_name=f'image6', )
